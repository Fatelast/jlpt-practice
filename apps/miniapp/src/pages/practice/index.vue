...
const initialMode: PracticeMode = initialParams?.mode === 'wrong' || initialParams?.mode === 'favorite'
  ? initialParams.mode
  : 'sequence';
...
const mode = ref<PracticeMode>(initialMode);
